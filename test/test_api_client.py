...
class AuthorizedApiIntegrationTest(TestCase):
    ...
    def test_upload_image_then_start_workflow_execution(self):
        organization, workflow = self.get_organization_and_workflow()
        ...
        self.assert_execution_has_started(organization, workflow, workflow_execution_id, input_image_content_hash, "input_image.jpeg", {"myLabel": "myValue"})
        self.assert_workflow_executions_contain_execution(organization, workflow, workflow_execution_id)

        self.wait_for_execution_to_complete(organization, workflow_execution_id)
        workflow_execution_completed = self.get_completed_execution_and_assert_fields(organization, workflow, workflow_execution_id, input_image_content_hash, "input_image.jpeg", {"myLabel": "myValue"})

        self.download_result_and_assert_equal(organization, workflow_execution_completed)
    ...
    def get_organization_and_workflow(self) -> Tuple[Organization, Workflow]:
    ...
    def assert_execution_has_started(self, organization: Organization, workflow: Workflow, workflow_execution_id: UUID,
    ...
    def wait_for_execution_to_complete(self, organization: Organization, workflow_execution_id: UUID):
        timeout = 10
        interval = 1
        seconds_waited = 0
    ...
    def get_completed_execution_and_assert_fields(self, organization: Organization, workflow: Workflow, workflow_execution_id: UUID,
    ...
    def download_result_and_assert_equal(self, organization: Organization, workflow_execution: WorkflowExecution):
